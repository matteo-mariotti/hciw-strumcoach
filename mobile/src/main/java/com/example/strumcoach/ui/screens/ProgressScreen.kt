        ...
        LazyColumn(
            ...
            item {
                ...
                Surface(
                    ...
                    modifier = Modifier.fillMaxWidth().clickable { onOpenAchievements() }
                ) {
                    Row(
                        ...
                        Text(text = "Level ${level.level}", style = MaterialTheme.typography.titleSmall, fontWeight = FontWeight.Bold)
                        if (streak > 0) {
                            ...
                            Text(text = "$streak", style = MaterialTheme.typography.titleSmall, fontWeight = FontWeight.Bold)
                        }
                        Spacer(modifier = Modifier.weight(1f))
                        Text(text = "Achievements", style = MaterialTheme.typography.labelLarge, color = MaterialTheme.colorScheme.primary)
